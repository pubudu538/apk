...
type Server interface {
	...
	apkmgt.APKMgtOrgDiscoveryServiceServer
...
type server struct {
	...
	apkmgt.UnimplementedAPKMgtOrgDiscoveryServiceServer
	rest  rest.Server
...
func (s *server) StreamAPKMgtOrganizations(stream apkmgt.APKMgtOrgDiscoveryService_StreamAPKMgtOrganizationsServer) error {
	return s.StreamHandler(stream, resource.OrganizationListType)
}
